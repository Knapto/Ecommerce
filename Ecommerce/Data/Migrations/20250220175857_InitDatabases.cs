    ...
    public partial class InitDatabases : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Burger s Vepřovým mase a rajčetem", "Burger", 199m, 2 },
                    { 2, 2, "Slepičí Vývar s Celerem", "Slepičí Vývar", 99m, 5 },
                    { 3, 3, "Hm kaše", "Bramborová kaše", 45m, 0 },
                    { 4, 4, "Vodka s Rajčetem", "CockTail", 999m, 9999 }
                });
